        ...
        if (peso>0 && peso<=5) {
            ...
            if (zona==1||zona==2||zona==3||zona==4 ||zona==5) {
                if (zona==1) {
                    ...
                    }else{System.out.println("No aceptastes realizar el envio, por ende se cancela.");}
                    
                }
                if (zona==2) {double costo2=0;
            ...
            }else{System.out.println(" Error, solo existe un rango de ops, que van del 1 al 5, tu has ingresado "+zona);}
            
            
        }else{System.out.println(" ERROR, no se podra transportar mientras no este en el rango de capacidad  de 1 a 5 kg");}
    }
